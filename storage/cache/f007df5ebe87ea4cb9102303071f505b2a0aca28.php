        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="card product-card h-100 border-0 shadow-sm">
                <div class="position-absolute top-0 end-0 p-2">
                    <a href="/wishlist/remove/<?php echo e($item['product_id']); ?>" class="btn-remove">
                        <i class="fas fa-trash-alt"></i>
                    </a>
                </div>
                <?php if(!empty($item['image'])): ?>
                  <img src="/uploads/<?php echo e($item['image']); ?>" class="card-img-top" alt="<?php echo e($item['name']); ?>" style="height: 200px; object-fit: cover; border-radius: 12px 12px 0 0;">
                <?php else: ?>
                ...
                <div class="card-body p-3">
                    ...
                    <p class="fw-bold text-primary mb-3"><?php echo e(number_format($item['price'])); ?> đ</p>
                    <div class="d-flex gap-2">
                        <a href="/product/detail/<?php echo e($item['product_id']); ?>" class="btn btn-sm btn-outline-primary w-100">Chi tiết</a>
                        <a href="/cart/add/<?php echo e($item['product_id']); ?>" class="btn btn-sm btn-primary w-100">Thêm vào giỏ</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\Xamppp\xampp moi\htdocs\php2-2026-main\app\views/wishlist/index.blade.php ENDPATH**/ ?>