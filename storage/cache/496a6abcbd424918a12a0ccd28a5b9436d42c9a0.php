...
<body>
    ...
    <main class="container py-5">
        <div class="status-header d-flex justify-content-between align-items-center">
            <div>
                <h4 class="fw-bold mb-1">Mã đơn hàng: #ORD-<?php echo e($order['id']); ?></h4>
            ...
            <div class="text-end">
                ...
                <span class="badge <?php echo e($status['class']); ?> rounded-pill px-4 py-2"><?php echo e($status['text']); ?></span>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="card detail-card p-4 shadow-sm bg-white">
                        ...
                        <table class="table align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end fw-bold"><?php echo e(number_format($item['product_price'] * $item['quantity'])); ?> đ</td>
                                </tr>
                    ...
                    <div class="mt-4 pt-4 border-top d-flex justify-content-between align-items-center">
                        ...
                        <h4 class="fw-bold mb-0 text-primary"><?php echo e(number_format($order['total_amount'])); ?> đ</h4>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\Xamppp\xampp moi\htdocs\php2-2026-main\app\views/order/detail.blade.php ENDPATH**/ ?>