          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card product-card h-100 border-0">
              <?php if(!empty($product['image'])): ?>
                <img src="/uploads/<?php echo e($product['image']); ?>" class="card-img-top" alt="<?php echo e($product['name']); ?>" style="height: 220px; object-fit: cover;">
              <?php else: ?>
              ...
              <div class="card-body p-3">
                ...
                <p class="product-price mb-3"><?php echo e(number_format($product['price'])); ?> đ</p>
                <div class="d-flex gap-2">
                   ...
                   <a href="/cart/add/<?php echo e($product['id']); ?>" class="btn btn-sm btn-primary w-100">Mua ngay</a>
                </div>
              </div>
            </div>
          </div>
...
<?php /**PATH D:\Xamppp\xampp moi\htdocs\php2-2026-main\app\views/home/index.blade.php ENDPATH**/ ?>