...
<head>
    ...
    <title><?php echo e($title); ?> - MyShop</title>
    ...
    <main class="container py-5">
        ...
        <?php if(isset($_SESSION['error'])): ?>
            <div class="alert alert-warning alert-dismissible fade show rounded-4 shadow-sm border-0 mb-4" role="alert">
                <i class="fas fa-exclamation-triangle me-2"></i> <?php echo e($_SESSION['error']); ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border-0 py-3">
                                        <div class="d-flex align-items-center gap-3">
                                            <?php if(!empty($item['image'])): ?>
                                                <img src="/uploads/<?php echo e($item['image']); ?>" class="cart-item-img" alt="<?php echo e($item['name']); ?>">
                                            <?php else: ?>
                                            ...
                                            <?php endif; ?>
                                            <div>
                                                <h6 class="mb-0 fw-semibold"><?php echo e($item['name']); ?></h6>
                                                <small class="text-muted"><?php echo e(number_format($item['price'], 0, ',', '.')); ?> đ</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="border-0 text-center py-3">
                                        <div class="d-flex align-items-center justify-content-center gap-2">
                                            <a href="/cart/update/<?php echo e($id); ?>?type=minus" class="btn btn-sm btn-outline-secondary btn-quantity">-</a>
                                            <span class="fw-semibold px-2"><?php echo e($item['quantity']); ?></span>
                                            <a href="/cart/update/<?php echo e($id); ?>?type=plus" class="btn btn-sm btn-outline-secondary btn-quantity">+</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="border-0 text-end py-3">
                                        <a href="/cart/delete/<?php echo e($id); ?>" class="text-danger p-2" onclick="return confirm('Xóa sản phẩm này?')">Xóa</a>
                                    </td>
                                </tr>
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm p-4">
                    ...
                    <div class="d-flex justify-content-between mb-4 mt-2">
                        ...
                        <span class="fw-bold h5 mb-0 text-danger"><?php echo e(number_format($total, 0, ',', '.')); ?> đ</span>
                    </div>
...
<?php /**PATH D:\Xamppp\xampp moi\htdocs\php2-2026-main\app\views/cart/index.blade.php ENDPATH**/ ?>