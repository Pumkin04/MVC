                    ...
                    <form action="/checkout/process" method="POST">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="customer_name" class="form-control" value="<?php echo e($user['username'] ?? ''); ?>" required placeholder="Nguyễn Văn A">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-bold text-muted">Email</label>
                                <input type="email" name="customer_email" class="form-control" value="<?php echo e($user['email'] ?? ''); ?>" required placeholder="email@example.com">
                            </div>
                            <div class="col-md-6">
                ...
                <div class="checkout-card card p-4 bg-white sticky-top" style="top: 100px;">
                        ...
                        <div class="order-summary-item d-flex gap-3">
                            <div class="position-relative">
                                <?php if(!empty($item['image'])): ?>
                                    <img src="/uploads/<?php echo e($item['image']); ?>" width="64" height="64" class="rounded-3 shadow-sm" style="object-fit: cover;">
                                <?php else: ?>
                            ...
                            <div class="flex-grow-1">
                                <h6 class="mb-0 small fw-bold text-truncate" style="max-width: 180px;"><?php echo e($item['name']); ?></h6>
                                <small class="text-muted"><?php echo e(number_format($item['price'])); ?> đ</small>
                            </div>
                    ...
                    <div class="mt-4 pt-4 border-top">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-semibold"><?php echo e(number_format($total)); ?> đ</span>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <h5 class="fw-bold mb-0 text-primary"><?php echo e(number_format($total)); ?> đ</h5>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\Xamppp\xampp moi\htdocs\php2-2026-main\app\views/checkout/index.blade.php ENDPATH**/ ?>